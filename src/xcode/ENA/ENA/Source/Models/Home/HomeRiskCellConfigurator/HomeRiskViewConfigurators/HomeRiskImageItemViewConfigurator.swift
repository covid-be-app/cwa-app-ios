...
final class HomeRiskImageItemViewConfigurator: HomeRiskViewConfigurator {
	...
	init(title: String, titleColor: UIColor, iconImage: UIImage, iconTintColor: UIColor, color: UIColor, separatorColor: UIColor) {
		self.title = title
	...
	func configure(riskView: RiskImageItemView) {
		riskView.iconImageView?.image = iconImage
