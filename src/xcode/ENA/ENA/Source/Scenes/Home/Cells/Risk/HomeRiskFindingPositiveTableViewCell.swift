...
protocol HomeRiskFindingPositiveTableViewCellDelegate: AnyObject {
	func nextButtonTapped(cell: HomeRiskFindingPositiveTableViewCell)
}

class HomeRiskFindingPositiveTableViewCell: HomeCardTableViewCell {
	...
	weak var delegate: HomeRiskFindingPositiveTableViewCellDelegate?
