...
protocol HomeRiskInactiveTableViewCellDelegate: AnyObject {
	func activeButtonTapped(cell: HomeRiskInactiveTableViewCell)
}

class HomeRiskInactiveTableViewCell: HomeCardTableViewCell {
	weak var delegate: HomeRiskInactiveTableViewCellDelegate?
