...
enum AppStrings {
	...
	enum ExposureSubmissionResult {
		...
		static let furtherInfos_Disclaimer = NSLocalizedString("ExposureSubmissionResult_testNegative_disclaimer", comment: "")
	...
	enum AppInformation {
		...
		static let imprintSection5Text = NSLocalizedString("App_Information_Imprint_Section5_Text", comment: "")
