...
struct ENFRiskCalculationResult: Codable {
	...
	init(
		...
		riskLevelPerDate: [Date: ENFRiskLevel],
	...
	init(from decoder: Decoder) throws {
		...
		riskLevel = try container.decode(ENFRiskLevel.self, forKey: .riskLevel)
		...
		riskLevelPerDate = try container.decodeIfPresent([Date: ENFRiskLevel].self, forKey: .riskLevelPerDate) ?? [:]
	...
	let riskLevelPerDate: [Date: ENFRiskLevel]
